...
def config_train():
    ...
    parser.add_argument('--data_file', type=str,
                        default='../tf_w2v/data/ice_and_fire.txt',
                        help='data file')
    ...
    #num_unit
    parser.add_argument('--num_unrollings', type=int, default=20,
    ...
    input_args = '--data_file ../tf_w2v/data/ice_and_fire.txt --output_dir output_ice_fire --hidden_size 257 --embedding_size 128 --num_unrollings 20 --debug --encoding utf-8'
